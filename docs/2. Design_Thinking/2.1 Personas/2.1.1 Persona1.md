...
Q4-  Geilson se sente com medo de perder sua posição dentro da organização por estar se sentindo debilitado em seu  ambiente de trabalho. Ele retala que está preocupado por não possuir controle de suas emoções e que tem se frustrado por não encontrar um aplicativo pago que traga benefícios claros e tangíveis,especialmente aplicações capazes de se adaptar a sua rotina de trabalho.
# Contexto
